...
public class MealAdapter extends RecyclerView.Adapter<com.example.foodieapp2.MealAdapter.ViewHolder> {
...
//            dialogBuilder.setTitle(R.string.dialog_title);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements
        ...
        public ViewHolder(View itemView){
            super(itemView);
            textInfo = (TextView) itemView.findViewById(R.id.textDescription);
